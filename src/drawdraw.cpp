    ...
    if(MainWindow::amr_s_1.online_status == 1){
       ...
       //4号小车绘画
        ...
        //判断接驳台状态
            ...
            else if(Conection_1_State == 0)
            {
                m_painter->setBrush(Qt::green);
                m_painter->setPen(Qt::darkGreen);
                m_painter->drawEllipse(QPoint(531,map_w-340),8,8);
                m_painter->drawText(QRect(541,map_w-346,120,20),"空闲");
            }
            if(Conection_1_State == 1)
            {
                m_painter->setBrush(Qt::yellow);
                ...
                m_painter->drawText(QRect(541,map_w-176,120,20),"忙碌");
            }
            else if(Conection_2_State == 0)
            {
                m_painter->setBrush(Qt::green);
                m_painter->setPen(Qt::darkGreen);
                m_painter->drawEllipse(QPoint(531,map_w-170),8,8);
